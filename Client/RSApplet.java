...
public class RSApplet extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener,
	...
	private class RSFrame extends Frame {
		
		private static final long serialVersionUID = 6483198269040754386L;

		public RSFrame(RSApplet applet, int i, int j) {
			rsApplet = applet;
		}

		public Graphics getGraphics() {
			Graphics graphic = super.getGraphics();
			graphic.translate(4, 24);
			return graphic;
		}
	...
	public final void keyPressed(KeyEvent keyevent) {
		...
		int charValue = keyevent.getKeyChar();
		// hotkeys here
		...
		if (charValue > 0 && charValue < 128)
			keyArray[charValue] = 1;
		if (charValue > 4) {
			charQueue[writeIndex] = charValue;
