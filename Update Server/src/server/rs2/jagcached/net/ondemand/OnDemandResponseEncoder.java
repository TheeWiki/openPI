package server.rs2.jagcached.net.ondemand;
...
public final class OnDemandResponseEncoder extends OneToOneEncoder {
	...
	protected Object encode(ChannelHandlerContext ctx, Channel c, Object msg) throws Exception {
		if (msg instanceof OnDemandResponse) {
			...
			buf.writeShort(fileSize);// this is the file size it is writing it as unsigned short which only hold 65kb u need 2 use a medium or something, 
