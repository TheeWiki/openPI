...
public class ArrayToEnum {
	...
	private static String[] WAVES = new String[] { "{TZ_KIH}", "{TZ_KIH,TZ_KIH}", "{TZ_KEK}", "{TZ_KEK,TZ_KIH}",
			...
			"{TOK_XIL,TOK_XIL}", "{YT_MEJKOT}", "{YT_MEJKOT,TZ_KIH}", "{YT_MEJKOT,TZ_KIH,TZ_KIH}", "{YT_MEJKOT,TZ_KEK}",
			"{YT_MEJKOT,TZ_KEK,TZ_KIH}", "{YT_MEJKOT,TZ_KEK,TZ_KIH,TZ_KIH}", "{YT_MEJKOT,TZ_KEK,TZ_KEK}",
			"{YT_MEJKOT,TOK_XIL}", "{YT_MEJKOT,TOK_XIL,TZ_KIH}", "{YT_MEJKOT,TOK_XIL,TZ_KIH,TZ_KIH}",
			"{YT_MEJKOT,TOK_XIL,TZ_KEK}", "{YT_MEJKOT,TOK_XIL,TZ_KEK,TZ_KIH}",
