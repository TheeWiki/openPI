...
public class CombatAssistant{
	...
	**/
	...
	public int mageAtk() {
        ...
        if(c.fullVoidMage())
            attackLevel = (int)((double)attackLevel + (double)c.getLevelForXP(c.playerXP[6]) * 0.20000000000000001D);
        if(c.prayerActive[4])
            attackLevel = (int)((double)attackLevel * 1.05D);
        else
        if(c.prayerActive[12])
            attackLevel = (int)((double)attackLevel * 1.1000000000000001D);
        else
        if(c.prayerActive[20])
            attackLevel = (int)((double)attackLevel * 1.1499999999999999D);
    ...
    public int mageDef() {
        ...
        if(c.prayerActive[4])
            defenceLevel = (int)((double)defenceLevel + (double)c.getLevelForXP(c.playerXP[c.playerDefence]) * 0.050000000000000003D);
        else
        if(c.prayerActive[12])
            defenceLevel = (int)((double)defenceLevel + (double)c.getLevelForXP(c.playerXP[c.playerDefence]) * 0.10000000000000001D);
        else
        if(c.prayerActive[20])
            defenceLevel = (int)((double)defenceLevel + (double)c.getLevelForXP(c.playerXP[c.playerDefence]) * 0.14999999999999999D);
