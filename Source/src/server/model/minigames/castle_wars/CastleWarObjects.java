...
public class CastleWarObjects {
	...
	/**
	 * The areas and coordinates of the castle wars minigame.
	 * @param c
	 * @param id
	 * @param x
	 * @param y
	...
	public void handleObject(Client c, int id, int x, int y) {
		...
		/**
		 * Team two can't go in team one's spawn point.
		 */
			case 4469:
			...
			/**
			 * Team one can't go in team two's spawn point.
			 */
			case 4470:
